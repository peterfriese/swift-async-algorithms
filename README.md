...
- [`flatMapLatest(_:...)`](https://github.com/apple/swift-async-algorithms/blob/main/Sources/AsyncAlgorithms/AsyncAlgorithms.docc/Guides/FlatMapLatest.md): Transforms elements into new asynchronous sequences, emitting elements from only the most recent one.
